...
export default function Edit({ debtor, companies, currentCompanyId }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('debtors.update', { debtor: debtor.id }));
    };
            ...
            header={
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <CompanyPicker
                        ...
                        routeName="debtors.edit"
                        routeParams={{ debtor: debtor.id }}
                        query={{}}
                    />
                </div>
            }
        >
            <Head title="Edit debtor" />
                ...
                <div className="mx-auto max-w-2xl sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div>
                            <InputLabel
                                htmlFor="balance"
                                value="Balance owed to you (dollars)"
                            />
                            <TextInput
                                id="balance"
                                type="number"
