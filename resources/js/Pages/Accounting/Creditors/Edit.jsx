...
export default function Edit({ creditor, companies, currentCompanyId }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        balance: String(creditor.balance),
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('creditors.update', { creditor: creditor.id }));
    };
            ...
            header={
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <CompanyPicker
                        ...
                        routeName="creditors.edit"
                        routeParams={{ creditor: creditor.id }}
                        query={{}}
                    />
                </div>
            }
        >
            <Head title="Edit creditor" />
