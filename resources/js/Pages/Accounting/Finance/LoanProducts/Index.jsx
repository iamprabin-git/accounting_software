...
export default function Index({ products, companies, currentCompanyId }) {
    ...
    const destroy = (id) => {
        ...
        router.delete(
            route('finance.loan-products.destroy', { loanProduct: id }),
            { data: companyQ },
        );
    };
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        {companies?.length > 0 && (
                            <CompanyPicker
                                ...
                                routeName="finance.loan-products.index"
                                routeParams={{}}
                                query={{}}
                            />
                        )}
            ...
            <div className="py-8">
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8">
                    <p className="mb-4 text-sm text-gray-600">
                        Define products (e.g. code <span className="font-mono">11</span>
                        ) so member loan accounts can be numbered{' '}
                        <span className="font-mono">11-0001</span>,{' '}
                        <span className="font-mono">11-0002</span>, … after back
                        office approval.
                    </p>
