...
export default function Edit({ product, companies, currentCompanyId }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(
            route('finance.savings-products.update', {
                savingsProduct: product.id,
            }),
        );
    };
    ...
    return (
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    {companies?.length > 0 && (
                        <CompanyPicker
                            ...
                            routeName="finance.savings-products.edit"
                            routeParams={{ savingsProduct: product.id }}
                            query={{}}
                        />
                    )}
                </div>
        ...
        >
            <Head title="Edit savings product" />
